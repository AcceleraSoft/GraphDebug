...
export interface CancelResponse extends SuccessResponse {
    command: 'cancel';
}
...
*/
export interface InitializedEvent extends EventBase {
    event: 'initialized';
}
...
*/
export interface StoppedEvent extends EventBase {
    event: 'stopped';
    body: {
...
*/
export interface ContinuedEvent extends EventBase {
...
*/
export interface TerminatedEvent extends EventBase {
    event: 'terminated';
    body?: {
...
*/
export interface BreakpointEvent extends EventBase {
    event: 'breakpoint';
    body: {
        /** The reason for the event.
...
*/
export interface LoadedSourceEvent extends EventBase {
    event: 'loadedSource';
    body: {
        /** The reason for the event. */
        reason: 'new' | 'changed' | 'removed';
...
*/
export interface CapabilitiesEvent extends EventBase {
    event: 'capabilities';
    body: {
...
*/
export interface ProgressStartEvent extends EventBase {
    event: 'progressStart';
    body: {
...
/** Event message for 'progressUpdate' event type.
    ...
    This event should only be sent if the client has passed the value true for the 'supportsProgressReporting' capability of the 'initialize' request.
*/
export interface ProgressUpdateEvent extends EventBase {
...
/** Event message for 'progressEnd' event type.
    ...
    This event should only be sent if the client has passed the value true for the 'supportsProgressReporting' capability of the 'initialize' request.
*/
export interface ProgressEndEvent extends EventBase {
    event: 'progressEnd';
    body: {
...
export interface RunInTerminalResponse extends SuccessResponse {
    command: 'runInTerminal';
    body: {
...
*/
export interface ConfigurationDoneRequest extends RequestBase {
...
export interface ConfigurationDoneResponse extends SuccessResponse {
    command: 'configurationDone';
}
...
export interface LaunchResponse extends SuccessResponse {
    command: 'launch';
}
...
export interface AttachResponse extends SuccessResponse {
    command: 'attach';
}
...
*/
export interface RestartRequest extends RequestBase {
    command: 'restart';
...
export interface RestartResponse extends SuccessResponse {
    command: 'restart';
}
...
*/
export interface DisconnectRequest extends RequestBase {
    command: 'disconnect';
...
export interface DisconnectResponse extends SuccessResponse {
    command: 'disconnect';
}
...
export interface TerminateResponse extends SuccessResponse {
    command: 'terminate';
}
...
*/
export interface BreakpointLocationsRequest extends RequestBase {
...
*/
export interface BreakpointLocationsResponse extends SuccessResponse {
    command: 'breakpointLocations';
    body: {
...
*/
export interface SetBreakpointsRequest extends RequestBase {
...
*/
export interface SetBreakpointsResponse extends SuccessResponse {
    command: 'setBreakpoints';
    body: {
...
*/
export interface SetFunctionBreakpointsRequest extends RequestBase {
...
/** Response to 'setFunctionBreakpoints' request.
    Returned is information about each breakpoint created by this request.
*/
export interface SetFunctionBreakpointsResponse extends SuccessResponse {
    command: 'setFunctionBreakpoints';
    body: {
...
*/
export interface SetExceptionBreakpointsRequest extends RequestBase {
...
export interface SetExceptionBreakpointsResponse extends SuccessResponse {
    command: 'setExceptionBreakpoints';
}
...
*/
export interface DataBreakpointInfoRequest extends RequestBase {
...
export interface DataBreakpointInfoResponse extends SuccessResponse {
    command: 'dataBreakpointInfo';
    body: {
...
/** SetDataBreakpoints request; value of command field is 'setDataBreakpoints'.
    ...
    Clients should only call this request if the capability 'supportsDataBreakpoints' is true.
*/
export interface SetDataBreakpointsRequest extends RequestBase {
...
/** Response to 'setDataBreakpoints' request.
    Returned is information about each breakpoint created by this request.
*/
export interface SetDataBreakpointsResponse extends SuccessResponse {
    command: 'setDataBreakpoints';
    body: {
...
*/
export interface SetInstructionBreakpointsRequest extends RequestBase {
...
export interface SetInstructionBreakpointsResponse extends SuccessResponse {
...
*/
export interface ContinueRequest extends RequestBase {
    command: 'continue';
...
export interface ContinueResponse extends SuccessResponse {
    command: 'continue';
    body: {
...
export interface NextResponse extends SuccessResponse {
    command: 'next';
}
...
*/
export interface StepInRequest extends RequestBase {
    command: 'stepIn';
...
export interface StepInResponse extends SuccessResponse {
    command: 'stepIn';
}
...
/** StepOut request; value of command field is 'stepOut'.
    ...
    The debug adapter first sends the response and then a 'stopped' event (with reason 'step') after the step has completed.
*/
export interface StepOutRequest extends RequestBase {
    command: 'stepOut';
...
export interface StepOutResponse extends SuccessResponse {
    command: 'stepOut';
}
...
*/
export interface StepBackRequest extends RequestBase {
    command: 'stepBack';
...
export interface StepBackResponse extends SuccessResponse {
    command: 'stepBack';
}
...
/** ReverseContinue request; value of command field is 'reverseContinue'.
    ...
    Clients should only call this request if the capability 'supportsStepBack' is true.
*/
export interface ReverseContinueRequest extends RequestBase {
...
export interface ReverseContinueResponse extends SuccessResponse {
    command: 'reverseContinue';
}
...
*/
export interface RestartFrameRequest extends RequestBase {
...
export interface RestartFrameResponse extends SuccessResponse {
    command: 'restartFrame';
}
...
*/
export interface GotoRequest extends RequestBase {
    command: 'goto';
...
export interface GotoResponse extends SuccessResponse {
    command: 'goto';
}
...
*/
export interface PauseRequest extends RequestBase {
    command: 'pause';
...
export interface PauseResponse extends SuccessResponse {
    command: 'pause';
}
...
*/
export interface StackTraceRequest extends RequestBase {
    command: 'stackTrace';
...
export interface StackTraceResponse extends SuccessResponse {
    command: 'stackTrace';
    body: {
...
*/
export interface ScopesRequest extends RequestBase {
    command: 'scopes';
...
export interface ScopesResponse extends SuccessResponse {
    command: 'scopes';
    body: {
...
*/
export interface VariablesRequest extends RequestBase {
    command: 'variables';
...
export interface VariablesResponse extends SuccessResponse {
    command: 'variables';
    body: {
...
*/
export interface SetVariableRequest extends RequestBase {
    command: 'setVariable';
...
export interface SetVariableResponse extends SuccessResponse {
    command: 'setVariable';
    body: {
...
export interface SourceResponse extends SuccessResponse {
    command: 'source';
    body: {
...
*/
export interface ThreadsRequest extends RequestBase {
    command: 'threads';
}

/** Response to 'threads' request. */
export interface ThreadsResponse extends SuccessResponse {
    command: 'threads';
    body: {
        /** All threads. */
        threads: Thread[];
...
*/
export interface TerminateThreadsRequest extends RequestBase {
...
export interface TerminateThreadsResponse extends SuccessResponse {
    command: 'terminateThreads';
}
...
*/
export interface ModulesRequest extends RequestBase {
    command: 'modules';
...
export interface ModulesResponse extends SuccessResponse {
    command: 'modules';
    body: {
...
*/
export interface LoadedSourcesRequest extends RequestBase {
...
export interface LoadedSourcesResponse extends SuccessResponse {
    command: 'loadedSources';
    body: {
...
*/
export interface EvaluateRequest extends RequestBase {
    command: 'evaluate';
...
*/
export interface SetExpressionRequest extends RequestBase {
...
export interface SetExpressionResponse extends SuccessResponse {
    command: 'setExpression';
    body: {
...
*/
export interface StepInTargetsRequest extends RequestBase {
...
export interface StepInTargetsResponse extends SuccessResponse {
    command: 'setInTargets';
    body: {
...
*/
export interface GotoTargetsRequest extends RequestBase {
    command: 'gotoTargets';
...
export interface GotoTargetsResponse extends SuccessResponse {
    command: 'gotoTargets';
    body: {
...
*/
export interface CompletionsRequest extends RequestBase {
    command: 'completions';
...
export interface CompletionsResponse extends SuccessResponse {
    command: 'completions';
    body: {
...
*/
export interface ExceptionInfoRequest extends RequestBase {
...
export interface ExceptionInfoResponse extends SuccessResponse {
    command: 'exceptionInfoRequest';
    body: {
...
*/
export interface ReadMemoryRequest extends RequestBase {
    command: 'readMemory';
...
export interface ReadMemoryResponse extends SuccessResponse {
    command: 'readMemory';
    body?: {
...
*/
export interface DisassembleRequest extends RequestBase {
    command: 'disassemble';
...
export interface DisassembleResponse extends SuccessResponse {
    command: 'disassemble';
    body?: {
